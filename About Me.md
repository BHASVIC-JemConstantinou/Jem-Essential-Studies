...
## Work Showcase
### C-chapters
https://github.com/BHASVIC-CompSci/c-chapter1-intro-BHASVIC-JemConstantinou.git
https://github.com/BHASVIC-CompSci/c-chapter2-selection-ifstatements-BHASVIC-JemConstantinou.git
https://github.com/BHASVIC-CompSci/c-chapter3-case-BHASVIC-JemConstantinou.git
https://github.com/BHASVIC-CompSci/c-chapter4-iteration-BHASVIC-JemConstantinou.git
https://github.com/BHASVIC-CompSci/c-chapter5-arrays-BHASVIC-JemConstantinou.git
https://github.com/BHASVIC-CompSci/c-chapter6-2d-arrays-BHASVIC-JemConstantinou.git
https://github.com/BHASVIC-CompSci/c-chapter7-strings-BHASVIC-JemConstantinou.git
https://github.com/BHASVIC-CompSci/c-chapter8-subroutines-BHASVIC-JemConstantinou.git
### These show the tasks I completed whilst learning the language C at the start of the year. Whilst I found it challenging, I managed to complete all of the tasks and by the end of the chapters I felt confident using C to code solutions to problems, such as the next project listed in my showcase.
### Hotel Kasyyyk
...
### Animalopoly
https://github.com/BHASVIC-CompSci/animalopoly-BHASVIC-JemConstantinou.git
### This was the most recent group project we have completed in the year. It involved creating a board game in the style of Monolpoly using object orientated programming, including the making of a program to create animals, players, have the players buy and upgrade animals, a board, working dice rolls, and the use of cards with monetary values that players can either lose or gain. I was in charge of the animals and cards, and I successfully programmed my alloted tasks whilst fully documenting and annotating my process with my group. 
